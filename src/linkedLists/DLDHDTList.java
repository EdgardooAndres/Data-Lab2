...
public class DLDHDTList<E> implements LinkedList<E> {
	...
	public DLDHDTList() { 
		...
		DNode<E> dummyHeater = new DNode<E>();
		DNode<E> dummyTrailer = new DNode<E>();
		dummyHeater.setNext(dummyTrailer);
		dummyTrailer.setPrev(dummyHeater);		
	...
	public void removeNode(Node<E> target) {
		...
		DNode<E> delete = (DNode<E>) target; 
		DNode<E> dAfter =  delete.getNext(); 
		DNode<E> dBefore = delete.getPrev(); 
		dBefore.setNext(dAfter); 
		dAfter.setPrev(dBefore); 
		length--;		
